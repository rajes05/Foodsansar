...
export const { setUserData, setCurrentCity, setCurrentProvince, setCurrentAddress, setShopsInMyCity, setItemsInMyCity,addToCart, updateQuantity, removeCartItem, setMyOrders, addMyOrder , updateOrderStatus, setSearchItems} = userSlice.actions; // Export action creators : use useSelector and useDispatch 
