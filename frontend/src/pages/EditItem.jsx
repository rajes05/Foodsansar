...
function EditItem() {
  ...
  // Get current user and user's shop data from redux store
      ...
      <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="text" placeholder='Enter Food Item Name' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500' onChange={(e) => setName(e.target.value)} value={name} />
          </div>
          ...
          <div>
            ...
            <textarea placeholder='Enter Food Description' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[100px]' onChange={(e) => setDescription(e.target.value)} value={description} />
          </div>
          {/* *End Description */}
