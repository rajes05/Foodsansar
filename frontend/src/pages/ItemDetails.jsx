        ...
        >
            ...
            <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px 24px" }}>
                ...
                >
                    {/* === COL 1: Image Gallery === */}
                    <div
                        style={{ padding: "24px 16px", borderRight: "1px solid #f0f0f0" }}
                    >
                        {/* Main Image */}
                        <div
                            style={{
                    ...
                    {/* === COL 2: Product Info === */}
                    <div
                        style={{ padding: "24px 20px", borderRight: "1px solid #f0f0f0" }}
                    >
                        {/* Title */}
                        <h1
                            style={{
                        ...
                        >
                            <span style={{ fontWeight: 800, fontSize: 15, color: "#F85606" }}>
                                {avgRating.toFixed(1)}
                            </span>
                        ...
                        <div
                            style={{
                                ...
                                padding: "14px 16px",
                                borderRadius: 4,
                                borderLeft: "4px solid #F85606",
                            }}
                        >
                            <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                                <span style={{ color: "#F85606", fontSize: 22 }}>Rs </span>
                                <span
                                    style={{ fontSize: 30, fontWeight: 900, color: "#F85606" }}
                                >
                                    {item.price}
                                </span>
                            </div>
                        ...
                        >
                            {[
                                ...
                                <div key={label} style={{ display: "flex", gap: 0 }}>
                                    ...
                                    <span
                                        style={{ color: "#222", fontSize: 13, fontWeight: 600 }}
                                    >
                                        {value}
                                    </span>
                                </div>
                        ...
                        <div>
                            ...
                            <p style={{ color: "#666", fontSize: 13, lineHeight: 1.7 }}>
                                {item.description ||
                                    "Fresh and delicious, made with quality ingredients. Perfect for any meal time."}
                            </p>
                        </div>
                    </div>
                        ...
                        {activeTab === "description" && (
                            <div>
                                <p style={{ color: "#555", fontSize: 14, lineHeight: 1.9 }}>
                                    {item.description ||
                                        "This delicious item is prepared with the finest ingredients ensuring great taste and quality. Perfect for any occasion. Our chefs prepare this dish fresh to ensure maximum taste and nutrition."}
                                </p>
                                {/* Feature highlights */}
                                <div
                                    style={{
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Sourced daily for quality",
                                        },
                                        {
                                            icon: "👨‍🍳",
                                            title: "Expert Chefs",
                                            desc: "Prepared by professionals",
                                        },
                                        {
                                            icon: "⚡",
                                            title: "Quick Delivery",
                                            desc: "Hot & fresh to your door",
                                        },
                                        {
                                            icon: "✅",
                                            title: "Hygienic",
                                            desc: "Safety standards followed",
                                        },
                                    ].map((f) => (
                                        <div
                                            key={f.title}
                                    ...
                                    <div style={{ flex: 1, minWidth: 180 }}>
                                        {[5, 4, 3, 2, 1].map((star) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span
                                                        style={{ fontSize: 12, color: "#555", width: 8 }}
                                                    >
                                                        {star}
                                                    </span>
                                                    ...
                                                    <span
                                                        style={{ fontSize: 12, color: "#999", width: 24 }}
                                                    >
                                                        {count}
                                                    </span>
                                                </div>
